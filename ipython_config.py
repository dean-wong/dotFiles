...
# c.TerminalInteractiveShell.editor = u'mvim'
...
# paraiso-light, trac, default, algol, fruity, solarizeddark, solarizedlight,
# zenburn, base16_ocean_dark, material_light, tomorrow
